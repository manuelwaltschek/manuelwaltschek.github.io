          ...
          >
            ...
            >
              ...
              <div 
                ...
                :class="{
                  'bg-gradient-to-b from-black/50 via-black/25 to-transparent': doc.image,
                  'bg-gradient-to-b from-primary/10 to-transparent': !doc.image
                }"
              ></div>
            </div>
            ...
            <div class="relative">
              <div class="max-w-4xl mx-auto px-4 pt-8 pb-4">
                <div class="flex items-center gap-4 text-gray-800 mb-6">
                  ...
                  <time class="text-gray-800">{{ formatDate(doc.date) }}</time>
                  <span class="text-gray-500">|</span>
                  <span class="text-gray-800">{{ doc.readingTime }}</span>
                </div>
              </div>
            </div>
